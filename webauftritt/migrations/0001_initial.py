# Generated by Django 2.1.4 on 2019-04-26 10:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kategorie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webauftritt.Kategorie')),
            ],
            options={
                'verbose_name': 'Pferd',
        ...
        migrations.AddField(
            model_name='profile',
            name='Kurse',
            field=models.ManyToManyField(to='webauftritt.Kurs'),
        ),
        migrations.AddField(
            model_name='profile',
            name='groups',
